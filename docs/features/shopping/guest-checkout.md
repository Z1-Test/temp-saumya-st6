...
Enable unauthenticated users to complete purchase without account creation

This feature is part of the shopping bounded context and contributes to the itsme.fashion MVP by enabling enable unauthenticated users to complete purchase without account creation.

---

## 2. User Problem

Users need enable unauthenticated users to complete purchase without account creation to accomplish their shopping goals efficiently. Without this feature, customers experience friction and cannot complete essential e-commerce tasks.
...
- Enable seamless user interactions with enable unauthenticated users to complete purchase without account creation
...
Enable unauthenticated users to complete purchase without account creation with the following key behaviors:
...
**As a** customer
**I want** to enable unauthenticated users to complete purchase without account creation
...
**Rollout Strategy:**
- **Feature Flag:** `feature_shopping_guest_checkout` (enabled by default)
...
* **Roadmap:** Shopping Layer — Feature #2
